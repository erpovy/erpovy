                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-slate-400 text-sm font-medium flex items-center gap-2">
                            ...
                            Sisteme yeni bir araç tanımlayın
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="py-8">
        <div class="container mx-auto px-6 lg:px-8 max-w-4xl">
            <x-card class="border-gray-200 dark:border-white/10 bg-white/5 backdrop-blur-2xl p-8">
                <form action="{{ route('servicemanagement.vehicles.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="current_mileage" value="{{ old('current_mileage', 0) }}" required 
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="status" required 
                                ...
                                <option value="maintenance" {{ old('status') == 'maintenance' ? 'selected' : '' }}>Serviste</option>
                    ...
                    <div class="space-y-2 mb-8">
                        ...
                        <textarea name="notes" rows="4" 
                            class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-sm focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 outline-none transition-all dark:text-white">{{ old('notes') }}</textarea>
                    </div>

                    <div class="flex items-center justify-end gap-4">
                        <a href="{{ route('servicemanagement.vehicles.index') }}" class="px-8 py-4 rounded-xl bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-slate-400 font-black text-xs uppercase tracking-widest transition-all hover:bg-gray-200 dark:hover:bg-white/10">
                            İPTAL
                        </a>
