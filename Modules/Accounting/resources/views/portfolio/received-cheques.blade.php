    ...
    <x-slot name="header">
        <div class="relative overflow-hidden group">
            ...
            <div class="relative flex items-center justify-between py-2">
                ...
                <a href="{{ route('accounting.cheques.create', ['type' => 'received']) }}" class="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white rounded-xl font-semibold shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all flex items-center gap-2">
            ...
            <x-card class="border-white/10 bg-white/5 backdrop-blur-2xl overflow-hidden">
                        ...
                        <table class="w-full">
                            <thead class="bg-white/5 border-b border-white/10">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider">Keşideci (Müşteri)</th>
                                ...
                                @foreach($cheques as $cheque)
                                    <tr class="hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('accounting.cheques.show', $cheque) }}" class="text-green-400 hover:text-green-300">
                                                Görüntüle
                                            </a>
                                        </td>
                                    </tr>
                ...
                @else
                    <div class="p-12 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-slate-400 mb-2">Alınan çek bulunmuyor</h3>
                        <p class="text-slate-500 mb-6">Portföyünüzde henüz alınan çek bulunmamaktadır.</p>
                        <a href="{{ route('accounting.cheques.create', ['type' => 'received']) }}" class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-500 text-white rounded-xl font-semibold transition-all">
                            <span class="material-symbols-outlined">add</span>
                            Yeni Çek Ekle
                        </a>
                    </div>
