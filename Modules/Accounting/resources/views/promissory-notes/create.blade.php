            ...
            <form action="{{ route('accounting.promissory-notes.store') }}" method="POST">
                ...
                <x-card class="p-8 border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur-2xl">
                    ...
                    <div class="mb-6" x-data="{ type: '{{ old('type', request('type')) }}' }">
                        <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-3">Senet Tipi *</label>
                        <div class="grid grid-cols-2 gap-4">
                            <label class="group relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 outline-none"
                                ...
                                <div class="flex items-center gap-3 w-full">
                                    ...
                                    <div>
                                        <p class="font-bold text-lg transition-colors" :class="type === 'received' ? 'text-green-400' : 'text-gray-900 dark:text-white group-hover:text-green-400'">Alınan Senet</p>
                            ...
                            <label class="group relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 outline-none"
                                ...
                                <div class="flex items-center gap-3 w-full">
                                    ...
                                    <div>
                                        <p class="font-bold text-lg transition-colors" :class="type === 'issued' ? 'text-red-400' : 'text-gray-900 dark:text-white group-hover:text-red-400'">Verilen Senet</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Senet Numarası -->
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">Senet Numarası *</label>
                            <input type="text" name="note_number" value="{{ old('note_number') }}" required
                                   class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <!-- Borçlu -->
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">Borçlu (İsim/Unvan) *</label>
                        ...
                        <!-- Düzenleme Yeri -->
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">Düzenleme Yeri</label>
                        ...
                        <!-- Ödeme Yeri -->
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">Ödeme Yeri</label>
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <select name="currency" class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white">
                        ...
                        <!-- Keşide Tarihi -->
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">Düzenleme Tarihi *</label>
                            <input type="date" name="issue_date" value="{{ old('issue_date', date('Y-m-d')) }}" required
                                   class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                            @error('issue_date')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-900 dark:text-slate-300 mb-2">İlgili Cari Hesap (İsteğe Bağlı)</label>
                            <select name="contact_id" class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                            ...
                            <p class="text-xs text-gray-600 dark:text-slate-500 mt-1">Eğer bir cari hesaba bağlıysa buradan seçebilirsiniz.</p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="3" 
                                      class="w-full px-4 py-3 bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('notes') }}</textarea>
                        </div>
                    </div>

                    <!-- Butonlar -->
                    <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-white/10">
                        <a href="{{ route('accounting.promissory-notes.index') }}" class="px-6 py-3 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-900 dark:text-white rounded-lg font-medium transition-all">
                            İptal
                        </a>
