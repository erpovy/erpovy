        ...
        <div class="container mx-auto max-w-[1920px] px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">Toplam Aktif (Varlıklar)</h3>
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">Toplam Pasif (Yükümlülükler)</h3>
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">Özkaynaklar</h3>
            ...
            <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-sm text-slate-400">{{ $as_of_date }} tarihi itibariyle</span>
                </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-white/10">
                                    <th class="text-left py-3 px-4 text-sm font-semibold text-slate-400">Hesap Kodu</th>
                            ...
                            <tbody>
                                @foreach($assets as $asset)
                                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors">
                                        <td class="py-3 px-4 text-sm text-slate-300 font-mono">{{ $asset['code'] }}</td>
                                        <td class="py-3 px-4 text-sm text-white">{{ $asset['name'] }}</td>
                                ...
                                <tr class="bg-green-500/10 border-t-2 border-green-500/30">
                                    <td colspan="2" class="py-3 px-4 text-sm font-bold text-white">TOPLAM AKTİF</td>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                @foreach($liabilities as $liability)
                                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors">
                                        <td class="py-3 px-4 text-sm text-slate-300 font-mono">{{ $liability['code'] }}</td>
                                        <td class="py-3 px-4 text-sm text-white">{{ $liability['name'] }}</td>
                                ...
                                <tr class="bg-orange-500/10 border-t-2 border-orange-500/30">
                                    <td colspan="2" class="py-3 px-4 text-sm font-bold text-white">TOPLAM PASİF</td>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                @foreach($equity as $eq)
                                    <tr class="border-b border-white/5 hover:bg-white/5 transition-colors">
                                        <td class="py-3 px-4 text-sm text-slate-300 font-mono">{{ $eq['code'] }}</td>
                                        <td class="py-3 px-4 text-sm text-white">{{ $eq['name'] }}</td>
                                ...
                                <tr class="bg-blue-500/10 border-t-2 border-blue-500/30">
                                    <td colspan="2" class="py-3 px-4 text-sm font-bold text-white">TOPLAM ÖZKAYNAKLAR</td>
            ...
            <!-- Bilanço Dengesi -->
            <x-card class="p-6 border-white/10 bg-gradient-to-br from-{{ $total_assets == $total_liabilities_equity ? 'green' : 'red' }}-500/10 to-{{ $total_assets == $total_liabilities_equity ? 'emerald' : 'orange' }}-500/10 backdrop-blur-2xl border-{{ $total_assets == $total_liabilities_equity ? 'green' : 'red' }}-500/30">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-slate-300 mb-2">Toplam Aktif</h3>
                        <p class="text-4xl font-black text-green-400">{{ number_format($total_assets, 2) }}₺</p>
                    </div>
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-slate-300 mb-2">Toplam Pasif + Özkaynaklar</h3>
                ...
                <div class="mt-6 text-center">
                    ...
                    @endif
                    <p class="text-sm text-slate-400 mt-2">{{ $as_of_date }} tarihi itibariyle</p>
                </div>
            </x-card>
