        ...
        <div class="container mx-auto max-w-[1920px] px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="{{ route('accounting.reports.income-statement') }}" class="group relative block">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-green-500/30 transition-all duration-300 group-hover:-translate-y-1">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="material-symbols-outlined text-slate-600 group-hover:text-green-400 transition-colors">arrow_forward</span>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">Gelir Tablosu</h3>
                        <p class="text-sm text-slate-400">Gelir/Gider analizi ve Net Kar/Zarar hesaplaması</p>
                    </x-card>
                </a>
                ...
                <a href="{{ route('accounting.reports.balance-sheet') }}" class="group relative block">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-blue-500/30 transition-all duration-300 group-hover:-translate-y-1">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="material-symbols-outlined text-slate-600 group-hover:text-blue-400 transition-colors">arrow_forward</span>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">Bilanço</h3>
                        <p class="text-sm text-slate-400">Aktif/Pasif dengesi ve finansal durum</p>
                    </x-card>
                </a>
                ...
                <a href="{{ route('accounting.reports.trial-balance') }}" class="group relative block">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-purple-500/30 transition-all duration-300 group-hover:-translate-y-1">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="material-symbols-outlined text-slate-600 group-hover:text-purple-400 transition-colors">arrow_forward</span>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">Mizan</h3>
                        <p class="text-sm text-slate-400">Tüm hesapların borç/alacak toplamları</p>
                    </x-card>
                </a>
                ...
                <a href="{{ route('accounting.reports.vat-declaration') }}" class="group relative block">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-orange-500/30 transition-all duration-300 group-hover:-translate-y-1">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="material-symbols-outlined text-slate-600 group-hover:text-orange-400 transition-colors">arrow_forward</span>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">KDV Beyannamesi</h3>
                        <p class="text-sm text-slate-400">Hesaplanan/İndirilecek/Ödenecek KDV</p>
                    </x-card>
                </a>
            ...
            <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h4 class="text-lg font-bold text-white mb-2">Finansal Raporlar Hakkında</h4>
                        <p class="text-sm text-slate-400 leading-relaxed">
                            Tüm raporlar <span class="text-white font-semibold">Türk Muhasebe Standartları</span> ve 
                            <span class="text-white font-semibold">Tek Düzen Hesap Planı</span>'na uygun olarak hazırlanmaktadır. 
