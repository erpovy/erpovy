        ...
        <div class="container mx-auto max-w-[1920px] px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">Hesaplanan KDV (Satışlar)</h3>
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">İndirilecek KDV (Alışlar)</h3>
                ...
                <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                    ...
                    <h3 class="text-sm font-medium text-slate-400 mb-1">{{ $payable_vat >= 0 ? 'Ödenecek KDV' : 'Devreden KDV' }}</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-white">Hesaplanan KDV</p>
                                <p class="text-xs text-slate-400">Satışlardan kaynaklanan KDV (391)</p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between p-4 rounded-xl bg-green-500/10 border border-green-500/20">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-white">İndirilecek KDV</p>
                                <p class="text-xs text-slate-400">Alışlardan kaynaklanan KDV (191)</p>
                            </div>
                        </div>
                    ...
                    <!-- Ödenecek/Devreden KDV -->
                    <div class="flex items-center justify-between p-6 rounded-xl bg-gradient-to-br from-{{ $payable_vat >= 0 ? 'orange' : 'purple' }}-500/20 to-{{ $payable_vat >= 0 ? 'red' : 'pink' }}-500/20 border-2 border-{{ $payable_vat >= 0 ? 'orange' : 'purple' }}-500/30">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-lg font-bold text-white">{{ $payable_vat >= 0 ? 'Ödenecek KDV' : 'Devreden KDV' }}</p>
                                <p class="text-sm text-slate-400">Hesaplanan - İndirilecek = {{ $payable_vat >= 0 ? 'Ödenecek' : 'Devreden' }}</p>
                            </div>
                        </div>
            ...
            <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                <div class="flex items-center justify-center gap-4 text-center">
                    <div class="flex-1">
                        <p class="text-sm text-slate-400 mb-1">Hesaplanan KDV</p>
                        <p class="text-2xl font-black text-blue-400">{{ number_format($calculated_vat, 2) }}₺</p>
                    </div>
                    <span class="material-symbols-outlined text-slate-400 text-[32px]">remove</span>
                    <div class="flex-1">
                        <p class="text-sm text-slate-400 mb-1">İndirilecek KDV</p>
                        <p class="text-2xl font-black text-green-400">{{ number_format($deductible_vat, 2) }}₺</p>
                    </div>
                    <span class="material-symbols-outlined text-slate-400 text-[32px]">drag_handle</span>
                    <div class="flex-1">
                        <p class="text-sm text-slate-400 mb-1">{{ $payable_vat >= 0 ? 'Ödenecek' : 'Devreden' }}</p>
            ...
            <x-card class="p-6 border-white/10 bg-white/5 backdrop-blur-2xl">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        <h4 class="text-sm font-semibold text-white mb-2">KDV Beyannamesi Hakkında</h4>
