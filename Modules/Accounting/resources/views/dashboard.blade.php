            ...
            <div class="relative flex items-center justify-between py-2">
                ...
                <div class="hidden lg:flex items-center gap-3">
                    <div class="px-4 py-2 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-end">
                        <span class="text-[10px] text-slate-500 uppercase tracking-wider font-bold">Kasa/Banka</span>
                        <span class="text-lg font-black text-primary leading-none">{{ number_format($liquidBalance, 0) }}₺</span>
                    </div>
                    <div class="px-4 py-2 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-end">
                        <span class="text-[10px] text-slate-500 uppercase tracking-wider font-bold">Açık Fatura</span>
        ...
        <div class="container mx-auto max-w-[1920px] px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-green-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($totalIncome, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Toplam Gelir</div>
                        </div>
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-red-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($totalExpense, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Toplam Gider</div>
                        </div>
                        <div class="h-8 flex items-end gap-1 mt-4 opacity-50 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-blue-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($netProfit, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Net Kâr/Zarar</div>
                        </div>
                        <div class="h-8 flex items-end gap-1 mt-4 opacity-50 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-purple-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($liquidBalance, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Kasa & Banka Toplamı</div>
                        </div>
                        <div class="h-8 flex items-end gap-1 mt-4 opacity-50 group-hover:opacity-100 transition-opacity">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-orange-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($totalReceivables, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Toplam Müşteri Borcu</div>
                        </div>
                ...
                <div class="group relative">
                    ...
                    <x-card class="h-full relative p-6 border-white/10 bg-white/5 backdrop-blur-2xl hover:border-purple-500/30 transition-all duration-300 group-hover:-translate-y-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="text-3xl font-black text-white tracking-tight mb-1">₺{{ number_format($totalPayables, 0, ',', '.') }}</div>
                            <div class="text-xs text-slate-500 font-medium">Toplam Tedarikçi Borcu</div>
                        </div>
                        <a href="{{ route('accounting.account-transactions.index') }}" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <x-card class="h-full p-8 border-white/10 bg-white/5 backdrop-blur-2xl flex flex-col">
                        <div class="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p class="text-xs text-slate-500">Son 6 aylık finansal trendler</p>
                            </div>
                                ...
                                <div class="flex-1 group cursor-pointer flex flex-col justify-end h-full">
                                    <div class="flex gap-1 items-end h-full justify-center">
                                        ...
                                        <div class="flex-1 bg-gradient-to-t from-red-500/40 to-red-500 rounded-t-lg transition-all duration-500 group-hover:shadow-[0_0_15px_rgba(239,68,68,0.3)]"
                                             ...
                                             <!-- Tooltip -->
                                            <div class="absolute -top-16 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10 pointer-events-none z-10">
                                                -₺{{ number_format($report->expense, 0) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-center mt-3 text-[10px] font-bold text-slate-500 group-hover:text-white transition-colors uppercase">
                ...
                <div class="lg:col-span-1">
                    <x-card class="h-full p-8 border-white/10 bg-white/5 backdrop-blur-2xl flex flex-col">
                        ...
                        <div class="flex-1 overflow-y-auto pr-2 space-y-1 custom-scrollbar">
                            ...
                            <div class="flex items-center gap-4 p-3 rounded-xl hover:bg-white/5 transition-colors group cursor-pointer">
                                <div class="w-10 h-10 rounded-full flex items-center justify-center bg-white/5 text-slate-400 group-hover:bg-primary/10 group-hover:text-primary transition-all">
                                    <span class="material-symbols-outlined text-[18px]">receipt_long</span>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-sm text-white font-medium truncate">{{ $transaction->description ?: 'Genel İşlem' }}</div>
                                    <div class="text-[10px] text-slate-500 font-bold uppercase">{{ $transaction->date->diffForHumans() }}</div>
                                </div>
                                <div class="text-right">
                                    <div class="text-sm font-black text-white">₺{{ number_format($transaction->total_debit ?: $transaction->total_credit, 0) }}</div>
                                </div>
                            </div>
                            @empty
                            <div class="flex flex-col items-center justify-center h-full text-slate-500 py-8 opacity-50">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @foreach([
                    ...
                    <a href="{{ route($action['route']) }}" class="group relative overflow-hidden rounded-2xl">
                        <div class="absolute inset-0 bg-white/5 border border-white/10 transition-colors duration-300 group-hover:border-{{ $action['color'] }}-500/30 group-hover:bg-{{ $action['color'] }}-500/5"></div>
                        ...
                        <div class="relative p-6 flex items-center justify-center gap-4">
                            ...
                            <div class="font-black text-white text-sm uppercase tracking-wide group-hover:text-{{ $action['color'] }}-400 transition-colors">
                                {{ $action['label'] }}
                            </div>
                        </div>
                    </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        @forelse($topDebtors as $debtor)
                            <div class="flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="text-sm font-bold text-white">{{ $debtor->name }}</div>
                                        <div class="text-xs text-slate-500">{{ $debtor->type === 'customer' ? 'Müşteri' : 'Tedarikçi' }}</div>
                                    </div>
                                </div>
                                <div class="text-right">
                                    ...
                                    <a href="{{ route('accounting.account-transactions.show', $debtor->id) }}" 
                                       class="text-xs text-slate-500 hover:text-primary transition-colors">Ekstre →</a>
                                </div>
                            </div>
                        @empty
                            <div class="text-center text-slate-500 py-8">Borçlu müşteri bulunmuyor</div>
                        @endforelse
                    </div>
                </x-card>
                ...
                <x-card class="p-0 border-white/10 bg-white/5 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        @forelse($topCreditors as $creditor)
                            <div class="flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="text-sm font-bold text-white">{{ $creditor->name }}</div>
                                        <div class="text-xs text-slate-500">{{ $creditor->type === 'customer' ? 'Müşteri' : 'Tedarikçi' }}</div>
                                    </div>
                                </div>
                                <div class="text-right">
                        ...
                        @empty
                            <div class="text-center text-slate-500 py-8">Alacaklı tedarikçi bulunmuyor</div>
                        @endforelse
                    </div>
                </x-card>
            </div>
            ...
            <x-card class="p-0 border-white/10 bg-white/5 overflow-hidden flex flex-col">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-white/[0.02]">
                                <th class="p-4 text-[10px] font-black text-slate-500 uppercase tracking-widest">Fatura No</th>
                                <th class="p-4 text-[10px] font-black text-slate-500 uppercase tracking-widest">Müşteri / Kurum</th>
                                <th class="p-4 text-[10px] font-black text-slate-500 uppercase tracking-widest">Tarih</th>
                                <th class="p-4 text-[10px] font-black text-slate-500 uppercase tracking-widest text-right">Tutar</th>
                                <th class="p-4 text-[10px] font-black text-slate-500 uppercase tracking-widest text-center">Durum</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-colors group cursor-pointer">
                                ...
                                <td class="p-4">
                                    <div class="text-sm font-medium text-slate-300">{{ $invoice->contact->name ?? 'Müşteri Bilgisi Yok' }}</div>
                                </td>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="p-12 text-center text-slate-500 italic">Henüz fatura kaydı bulunmuyor.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
