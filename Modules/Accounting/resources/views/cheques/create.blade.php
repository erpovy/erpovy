                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="group relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 outline-none"
                                ...
                                <div class="flex items-center gap-3 w-full">
                                    ...
                                    <div>
                                        <p class="font-bold text-lg transition-colors" :class="type === 'received' ? 'text-green-400' : 'text-white group-hover:text-green-400'">Alınan Çek</p>
                            ...
                            <label class="group relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 outline-none"
                                ...
                                <div class="flex items-center gap-3 w-full">
                                    ...
                                    <div>
                                        <p class="font-bold text-lg transition-colors" :class="type === 'issued' ? 'text-red-400' : 'text-white group-hover:text-red-400'">Verilen Çek</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="cheque_number" value="{{ old('cheque_number') }}" required
                                   class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            @error('cheque_number')
                        ...
                        <div>
                            ...
                            <select name="currency" required class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="issue_date" value="{{ old('issue_date', date('Y-m-d')) }}" required
                                   class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-green-500">
                            @error('issue_date')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="contact_id" class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-green-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="3" 
                                      class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('notes') }}</textarea>
                        </div>
                    </div>

                    <!-- Butonlar -->
                    <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-white/10">
                        <a href="{{ route('accounting.cheques.index') }}" class="px-6 py-3 bg-white/5 hover:bg-white/10 text-white rounded-lg font-medium transition-all">
                            İptal
                        </a>
