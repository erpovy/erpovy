        ...
        <div class="relative overflow-hidden group">
            ...
            <div class="relative flex items-center justify-between py-2">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('accounting.invoices.create') }}" class="group relative px-6 py-3 overflow-hidden rounded-xl bg-primary text-white font-black text-sm uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(var(--color-primary),0.3)]">
                    ...
                    <div class="w-full md:w-64 relative" x-data="{ 
                        ...
                        <div x-show="open" 
                            ...
                            <div class="py-1">
                                ...
                                <button type="button" @click="select('sent', 'Gönderildi')" style="padding-left: 20px !important;" class="w-full pr-4 py-2.5 text-left text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-colors border-t border-white/5">Gönderildi</button>
                                <button type="button" @click="select('paid', 'Ödendi')" style="padding-left: 20px !important;" class="w-full pr-4 py-2.5 text-left text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-colors border-t border-white/5">Ödendi</button>
                                <button type="button" @click="select('overdue', 'Gecikmiş')" style="padding-left: 20px !important;" class="w-full pr-4 py-2.5 text-left text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-colors border-t border-white/5">Gecikmiş</button>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-white/[0.02] border-b border-white/5">
                                <th class="p-4 text-[11px] font-black text-slate-500 uppercase tracking-widest text-center w-36">Fatura No</th>
                                <th class="p-4 text-[11px] font-black text-slate-500 uppercase tracking-widest">Müşteri / Kurum</th>
                                <th class="p-4 text-[11px] font-black text-slate-500 uppercase tracking-widest text-center">Tarih</th>
                                <th class="p-4 text-[11px] font-black text-slate-500 uppercase tracking-widest text-right">KDV Hariç</th>
                                <th class="p-4 text-[11px] font-black text-slate-500 uppercase tracking-widest text-right">Toplam</th>
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-colors group">
                                ...
                                <td class="p-4">
                                    ...
                                    <div class="text-[10px] text-slate-500 font-bold uppercase">{{ $invoice->contact->tax_number ?? 'Vergi No Yok' }}</div>
                                </td>
                                <td class="p-4 text-center">
                                    <div class="text-sm font-bold text-white">
                                        {{ optional($invoice->issue_date)->format('d.m.Y') }}
                                    </div>
                                    <div class="text-[10px] text-slate-600 font-bold uppercase">vade: {{ optional($invoice->due_date)->format('d.m.Y') ?? 'N/A' }}</div>
                                </td>
                                ...
                                <td class="p-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a href="{{ route('accounting.invoices.show', $invoice) }}" class="p-2 rounded-lg bg-white/5 text-slate-400 hover:bg-white/10 transition-all active:scale-90" title="Detay">
