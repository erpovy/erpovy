        ...
        <div class="relative overflow-hidden group">
            ...
            <div class="relative flex items-center justify-between py-2">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('accounting.transactions.create') }}" class="group relative px-6 py-3 overflow-hidden rounded-xl bg-primary text-gray-900 dark:text-white font-black text-sm uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(var(--color-primary),0.3)]">
            ...
            <x-card class="p-4 border-gray-200 dark:border-white/10 bg-white/5 backdrop-blur-2xl">
                <form action="{{ route('accounting.transactions.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="w-full md:w-48 relative">
                        <select name="type" onchange="this.form.submit()" class="w-full pl-4 pr-10 py-3 bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white focus:border-primary/50 focus:ring-0 appearance-none">
                        ...
                        <span class="absolute right-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-gray-600 dark:text-slate-500 pointer-events-none">filter_list</span>
                    </div>
                    ...
                    <div class="w-full md:w-48 relative" x-data="{ 
                        ...
                        <button type="button" @click="open = !open" 
                                class="w-full pl-4 pr-4 py-3 bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-left focus:border-primary/50 focus:ring-0 transition-all flex items-center justify-between">
                            <span x-text="statusLabel" class="text-sm font-medium"></span>
                            <span class="material-symbols-outlined text-gray-600 dark:text-slate-500 transition-transform" :class="{'rotate-180': open}">expand_more</span>
                        </button>
                        ...
                        <div x-show="open" 
                             ...
                             class="absolute top-full left-0 w-full mt-2 bg-[#1e293b] border border-gray-200 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden z-50 backdrop-blur-xl">
                            <div class="py-1">
                                <button type="button" @click="select('', 'Tüm Durumlar')" 
                                        class="w-full px-4 py-2.5 text-left text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:text-white transition-colors">
                                    Tüm Durumlar
                                </button>
                                <button type="button" @click="select('approved', 'Onaylı')" 
                                        class="w-full px-4 py-2.5 text-left text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:text-white transition-colors border-t border-gray-200 dark:border-white/5">
                                    Onaylı
                                </button>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-white/[0.02] border-b border-gray-200 dark:border-white/5">
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest text-center w-32">Tarih</th>
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest">Fiş No</th>
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest text-center">Fiş Tipi</th>
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest">Açıklama</th>
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest text-right">Borç Toplamı</th>
                                <th class="p-4 text-[11px] font-black text-gray-600 dark:text-slate-500 uppercase tracking-widest text-right">Alacak Toplamı</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-white/5">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-white/5 transition-colors group">
                                <td class="p-4 text-center">
                                    <div class="text-sm font-bold text-gray-900 dark:text-white">{{ $transaction->date->format('d.m.Y') }}</div>
                                ...
                                <td class="p-4">
                                    <div class="text-sm font-medium text-gray-700 dark:text-slate-300 group-hover:text-gray-900 dark:text-white transition-colors">
