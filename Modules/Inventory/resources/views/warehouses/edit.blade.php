                ...
                <form action="{{ route('inventory.warehouses.update', $warehouse) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="address" name="address" rows="3"
                                  class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none">{{ old('address', $warehouse->address) }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <input type="checkbox" name="is_default" value="1" {{ $warehouse->is_default ? 'checked' : '' }}
