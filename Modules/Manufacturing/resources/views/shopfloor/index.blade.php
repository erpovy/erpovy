        ...
        <div class="container mx-auto max-w-[1920px] px-6 lg:px-12 space-y-8">
                ...
                <x-card class="p-8 relative overflow-hidden group border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-2xl transition-all duration-500 hover:border-blue-500/30 dark:hover:bg-white/10 hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="text-gray-600 dark:text-slate-400 text-xs font-black uppercase tracking-widest">Toplam İstasyon</div>
                        </div>
                ...
                <x-card class="p-8 relative overflow-hidden group border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-2xl transition-all duration-500 hover:border-green-500/30 dark:hover:bg-white/10 hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="text-gray-600 dark:text-slate-400 text-xs font-black uppercase tracking-widest">Aktif / Çalışıyor</div>
                        </div>
                ...
                <x-card class="p-8 relative overflow-hidden group border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-2xl transition-all duration-500 hover:border-yellow-500/30 dark:hover:bg-white/10 hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="text-gray-600 dark:text-slate-400 text-xs font-black uppercase tracking-widest">Bakımda</div>
                        </div>
                        <div class="text-5xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">{{ $stats['maintenance'] }}</div>
                ...
                <x-card class="p-8 relative overflow-hidden group border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-2xl transition-all duration-500 hover:border-red-500/30 dark:hover:bg-white/10 hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="text-gray-600 dark:text-slate-400 text-xs font-black uppercase tracking-widest">Kapalı / Arızalı</div>
                        </div>
                        <div class="text-5xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">{{ $stats['offline'] }}</div>
            ...
            <!-- Header for Grid -->
             <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-black text-gray-900 dark:text-white flex items-center gap-3">
                    <div class="p-2.5 rounded-xl bg-gray-200 dark:bg-white/10 text-gray-900 dark:text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @forelse($stations as $station)
                     <x-card class="p-8 relative overflow-hidden group border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-2xl transition-all duration-500 dark:hover:bg-white/10 hover:-translate-y-2 hover:shadow-2xl">
                         <!-- Status Indicator -->
                        ...
                        <div class="flex flex-col h-full justify-between relative z-10">
                            <div>
                                <div class="w-16 h-16 rounded-2xl bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-900 dark:text-white mb-6 group-hover:scale-110 transition-transform duration-500 border border-gray-300 dark:border-white/5 group-hover:border-gray-400 dark:group-hover:border-white/20">
                                ...
                                <h4 class="text-2xl font-black text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">{{ $station->name }}</h4>
                                <div class="text-sm font-bold text-gray-500 dark:text-slate-500 uppercase tracking-widest mb-6 border-b border-gray-200 dark:border-white/5 pb-6">{{ $station->code }}</div>
                            </div>

                            <div class="space-y-3">
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-gray-600 dark:text-slate-400 font-medium">Konum</span>
                                    <span class="text-gray-900 dark:text-white font-bold">{{ $station->location ?? '-' }}</span>
                                </div>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-gray-600 dark:text-slate-400 font-medium">Kapasite</span>
                                    <span class="text-gray-900 dark:text-white font-bold">{{ number_format($station->capacity, 0) }} / gün</span>
                                </div>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-gray-600 dark:text-slate-400 font-medium">Saatlik Maliyet</span>
                                    <div class="px-2 py-1 rounded bg-gray-100 dark:bg-white/5 border border-gray-300 dark:border-white/5 text-xs font-mono text-gray-900 dark:text-white">
                ...
                @empty
                    <div class="col-span-full text-center py-20 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] border border-gray-200 dark:border-white/10">
                        <div class="w-24 h-24 bg-gray-100 dark:bg-white/5 rounded-full flex items-center justify-center mx-auto mb-6">
                            <span class="material-symbols-outlined text-5xl text-slate-600">domain_disabled</span>
                        </div>
                        <p class="text-gray-600 dark:text-slate-400 font-medium text-xl">Henüz iş istasyonu tanımlanmamış.</p>
        ...
        <div x-show="openModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" x-cloak>
            ...
            <div class="relative bg-white dark:bg-[#1e1e2d] rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-200 dark:border-white/10 transform transition-all"
                ...
                <div class="px-8 py-6 border-b border-gray-200 dark:border-white/10 flex justify-between items-center bg-gray-50 dark:bg-white/[0.02]">
                    <h3 class="text-xl font-black text-gray-900 dark:text-white">Yeni İş İstasyonu Tanımla</h3>
                ...
                <form action="{{ route('manufacturing.shopfloor.store') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <!-- Code -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">İstasyon Kodu</label>
                            <input type="text" name="code" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4" placeholder="Örn: CNC-01" required>
                        </div>
                        
                        <!-- Name -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">İstasyon Adı</label>
                            <input type="text" name="name" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4" placeholder="Örn: CNC Kesim 1" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <!-- Type -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">Tip</label>
                        ...
                        <!-- Status -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">Durum</label>
                            <select name="status" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4" required>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <!-- Capacity -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">Günlük Kapasite</label>
                            <input type="number" name="capacity" min="0" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4" required>
                        </div>

                        <!-- Hourly Rate -->
                        <div>
                             <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">Saatlik Maliyet (₺)</label>
                            <input type="number" name="hourly_rate" min="0" step="0.01" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4">
                        </div>
                    </div>

                    <!-- Location -->
                    <div>
                         <label class="block text-xs font-bold text-gray-600 dark:text-slate-400 uppercase tracking-wider mb-2">Konum</label>
                        <input type="text" name="location" class="w-full rounded-xl border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-black/20 text-gray-900 dark:text-white focus:border-primary focus:ring-primary shadow-sm py-3 px-4" placeholder="Örn: Blok A, Zemin Kat">
                    </div>
