        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-10">
                <div>
                    ...
                    <p class="text-slate-400 mt-1 text-sm">Üretim süreçlerinizi tek bir noktadan yönetin</p>
                </div>
                <div class="flex space-x-3">
                    <button class="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/10 backdrop-blur-md transition-all duration-300 shadow-lg text-sm font-medium">
                        Raporlar
                    </button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="group relative rounded-2xl bg-white/5 border border-white/10 p-6 backdrop-blur-xl shadow-xl transition-all hover:bg-white/10 hover:shadow-2xl hover:-translate-y-1">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-blue-200 text-xs font-bold uppercase tracking-wider mb-1">Aktif İş Emirleri</p>
                            <h2 class="text-4xl font-bold text-white tracking-tight">{{ $activeWorkOrders }}</h2>
                            <p class="text-slate-400 text-xs mt-2">Devam eden üretimler</p>
                        </div>
                ...
                <div class="group relative rounded-2xl bg-white/5 border border-white/10 p-6 backdrop-blur-xl shadow-xl transition-all hover:bg-white/10 hover:shadow-2xl hover:-translate-y-1">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-amber-200 text-xs font-bold uppercase tracking-wider mb-1">Kalite Kontrol</p>
                            <h2 class="text-4xl font-bold text-white tracking-tight">{{ $pendingQualityChecks }}</h2>
                            <p class="text-slate-400 text-xs mt-2">Onay bekleyenler</p>
                        </div>
                 ...
                 <div class="group relative rounded-2xl bg-white/5 border border-white/10 p-6 backdrop-blur-xl shadow-xl transition-all hover:bg-white/10 hover:shadow-2xl hover:-translate-y-1">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-emerald-200 text-xs font-bold uppercase tracking-wider mb-1">Verimlilik</p>
                            <h2 class="text-4xl font-bold text-white tracking-tight">%94</h2>
                            <p class="text-slate-400 text-xs mt-2">Hedefin üzerinde</p>
                        </div>
            ...
            <div class="relative rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden">
                ...
                <div class="px-8 py-6 border-b border-white/5 flex justify-between items-center bg-white/5">
                    <h3 class="text-xl font-bold text-white">Son İş Emirleri</h3>
                    <button class="text-xs text-blue-300 hover:text-white transition-colors uppercase font-semibold">Tümünü Gör →</button>
                </div>
                
                <div class="overflow-x-auto">
                    <table class="min-w-full">
                        <thead class="bg-black/20 text-slate-300 uppercase text-xs font-semibold tracking-wider">
                            <tr>
                        ...
                        <tbody class="text-slate-300 text-sm divide-y divide-white/5">
                            @forelse($recentWorkOrders as $order)
                                <tr class="hover:bg-white/5 transition-colors duration-200 group">
                                    <td class="py-4 px-8 whitespace-nowrap font-medium text-white group-hover:text-blue-200 transition-colors">
                                        {{ $order->order_number }}
                                    </td>
                                    ...
                                    <td class="py-4 px-8 text-left font-mono text-slate-400">{{ $order->quantity }}</td>
                                    ...
                                    <td class="py-4 px-8 text-left text-slate-400">
                                        {{ $order->due_date ? $order->due_date->format('d.m.Y') : '-' }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="py-8 text-center text-slate-500 italic">Henüz kayıtlı iş emri bulunmamaktadır.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
