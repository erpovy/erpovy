            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
                ...
                <a href="{{ route('logistics.routes.create') }}" 
                   class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-2xl transition-all shadow-lg shadow-indigo-500/30 group">
                    <span class="material-icons-outlined mr-2 transition-transform group-hover:rotate-90">add</span>
                    YENİ ROTA OLUŞTUR
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-6 rounded-3xl">
                    ...
                    <div class="flex items-end justify-between mt-2">
                        ...
                        <span class="material-icons-outlined text-indigo-500/50 text-4xl">route</span>
                    </div>
                </div>
                <div class="bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-6 rounded-3xl">
                    ...
                    <div class="flex items-end justify-between mt-2">
                        ...
                        <span class="material-icons-outlined text-amber-500/50 text-4xl">history_edu</span>
                    </div>
                </div>
                <div class="bg-white/50 dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-6 rounded-3xl">
                    ...
                    <div class="flex items-end justify-between mt-2">
                        ...
                        <span class="material-icons-outlined text-emerald-500/50 text-4xl">task_alt</span>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors group">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="material-icons-outlined text-gray-400 text-sm">local_shipping</span>
