<x-app-layout>
    ...
    <div class="py-12" x-data="{
        ...
        status: '{{ old('status', $subscription->status) }}',
        get mrr() {
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <x-card class="p-8 !bg-[#0f172a]/40 border-white/5 backdrop-blur-3xl relative overflow-hidden shadow-2xl">
                        ...
                        <form action="{{ route('sales.subscriptions.update', $subscription->id) }}" method="POST" class="space-y-8 relative">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                                ...
                                <div class="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                                    ...
                                    <button type="submit" 
                                            class="w-full md:w-72 h-14 flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold text-[11px] uppercase tracking-widest hover:opacity-90 active:scale-95 shadow-2xl shadow-emerald-500/20 transition-all whitespace-nowrap">
