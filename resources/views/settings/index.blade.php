                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div x-data="{ preview: null }" class="group">
                                    ...
                                    <div class="relative h-64 rounded-2xl bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-2 border-dashed border-slate-700 hover:border-pink-500/50 transition-all cursor-pointer overflow-hidden group-hover:shadow-xl group-hover:shadow-pink-500/10"
                                        ...
                                        @if($logoCollapsed)
                                            <img x-show="!preview" src="{{ asset($logoCollapsed) }}" class="absolute inset-0 w-full h-full object-contain p-8">
                                        @endif
                                ...
                                <div x-data="{ preview: null }" class="group">
                                    ...
                                    <div class="relative h-64 rounded-2xl bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-2 border-dashed border-slate-700 hover:border-purple-500/50 transition-all cursor-pointer overflow-hidden group-hover:shadow-xl group-hover:shadow-purple-500/10"
                                        ...
                                        @if($logoExpanded)
                                            <img x-show="!preview" src="{{ asset($logoExpanded) }}" class="absolute inset-0 w-full h-full object-contain p-8">
                                        @endif
                                        ...
                                        @if(isset($loginBackground) && $loginBackground)
                                            <div x-show="!preview" class="absolute inset-0">
                                                @if(Str::endsWith($loginBackground, ['.mp4', '.webm']))
                                                    <video src="{{ asset($loginBackground) }}" class="w-full h-full object-cover" muted loop autoplay></video>
                                                @else
                                                    <img src="{{ asset($loginBackground) }}" class="w-full h-full object-cover">
                                                @endif
                                            </div>
                                        @endif
