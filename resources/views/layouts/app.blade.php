                        ...
                        <div class="flex items-center gap-4 md:gap-6">
                            ...
                            <div x-init="$watch('darkMode', value => { localStorage.setItem('theme', value ? 'dark' : 'light'); document.documentElement.classList.toggle('dark', value); })"
                                ...
                                <button @click="darkMode = !darkMode"
                                        class="relative w-14 h-8 rounded-full transition-all duration-300 shadow-inner overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        :class="darkMode ? 'bg-slate-800' : 'bg-slate-200'">
                                    
                                    <!-- Background Gradient (Dark Mode) -->
                                    <div class="absolute inset-0 transition-opacity duration-300 bg-gradient-to-r from-indigo-500 to-purple-600"
                                         :class="darkMode ? 'opacity-100' : 'opacity-0'"></div>

                                    <!-- Knob -->
                                    <div class="absolute top-1 left-1 w-6 h-6 rounded-full bg-white shadow-md transform transition-transform duration-300 flex items-center justify-center z-10"
