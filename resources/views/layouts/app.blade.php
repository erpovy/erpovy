                        ...
                        <div class="flex items-center gap-4 md:gap-6">
                            ...
                            <div x-init="$watch('darkMode', value => { 
                                ...
                                <button @click="darkMode = !darkMode"
                                        ...
                                        :class="darkMode ? 'bg-[#1e293b]' : 'bg-[#e0f2fe]'">
                                    
                                    <!-- Toggle Knob (Sun -> Moon) -->
                                    <div class="absolute top-[3px] left-[4px] w-6 h-6 rounded-full transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)]"
                                         :class="darkMode 
                                            ? 'translate-x-[32px] bg-transparent shadow-[inset_-6px_-2px_0_1px_#fbbf24] rotate-[220deg]' 
                                            : 'translate-x-0 bg-yellow-400 shadow-[0_0_10px_#facc15] rotate-0'">
                                    </div>

                                    <!-- Stars (Only visible in Dark Mode) -->
                                    <div class="absolute top-2 left-3 w-1 h-1 bg-white rounded-full transition-all duration-500 opacity-0 delay-100"
                                         :class="darkMode ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"></div>
                                    <div class="absolute bottom-2 left-6 w-0.5 h-0.5 bg-white rounded-full transition-all duration-500 opacity-0 delay-200"
                                         :class="darkMode ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"></div>
                                         
                                    <!-- Clouds/Rays (Only visible in Light Mode) -->
                                    <div class="absolute top-2 right-3 w-4 h-1 bg-white rounded-full transition-all duration-500"
                                         :class="darkMode ? 'opacity-0 translate-x-4' : 'opacity-100 translate-x-0'"></div>
                                    <div class="absolute bottom-2 right-4 w-2 h-1 bg-white rounded-full transition-all duration-500 delay-100"
                                         :class="darkMode ? 'opacity-0 translate-x-4' : 'opacity-100 translate-x-0'"></div>
                                </button>
