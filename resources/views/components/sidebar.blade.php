<aside 
        ...
        <div class="flex flex-col gap-2">
                ...
                <div>
                    <button type="button" @click.stop.prevent="toggle('accounting')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('accounting.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('accounting')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('accounting.dashboard') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.dashboard') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('accounting.accounts.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.accounts.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('accounting.transactions.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.transactions.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('accounting.invoices.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.invoices.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('accounting.invoice-templates.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.invoice-templates.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('accounting.cash-bank-accounts.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('accounting.cash-bank-accounts.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                    <button type="button" @click.stop.prevent="toggle('sales')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('sales.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('sales')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('crm.contacts.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('crm.contacts.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('crm.contacts.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Müşteri İlişkileri Yönetimi
                        </a>
                        <a href="{{ route('sales.sales.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('sales.sales.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('sales.sales.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Satışlar
                        </a>
                        <a href="{{ route('sales.quotes.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('sales.quotes.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('sales.quotes.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Teklif Hazırla
                        </a>
                        <a href="{{ route('sales.pos.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('sales.pos.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('sales.pos.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Satış Noktası
                        </a>
                        <a href="{{ route('sales.subscriptions.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('sales.subscriptions.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('sales.rentals.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('sales.rentals.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('crm')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('crm.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('crm')" x-cloak class="mt-1 space-y-1 pl-4">
                        ...
                        <a href="{{ route('crm.leads.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('crm.leads.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('crm.leads.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Potansiyel Müşteriler
                        </a>
                        <a href="{{ route('crm.deals.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('crm.deals.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('crm.deals.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Anlaşmalar
                        </a>
                        <a href="{{ route('crm.contracts.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('crm.contracts.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('inventory')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('inventory.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('inventory')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('inventory.analytics.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.analytics.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('inventory.products.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.products.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('inventory.categories.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.categories.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('inventory.brands.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.brands.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('inventory.brands.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Markalar
                        </a>
                        <a href="{{ route('inventory.units.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.units.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('inventory.units.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Ölçü Birimleri
                        </a>
                        <a href="{{ route('inventory.warehouses.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('inventory.warehouses.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('manufacturing')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('manufacturing.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('manufacturing')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('manufacturing.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.index') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.create') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.create') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.mrp.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.mrp.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.mes.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.mes.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.plm.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.plm.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.quality.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.quality.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.shopfloor.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.shopfloor.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        ...
                        <a href="{{ route('manufacturing.maintenance.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('manufacturing.maintenance.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('hr')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('hr.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('hr')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('hr.departments.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.departments.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('hr.departments.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Departmanlar
                        </a>
                        <a href="{{ route('hr.employees.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.employees.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('hr.employees.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Personel Listesi
                        </a>
                        <a href="{{ route('hr.leaves.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.leaves.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('hr.leaves.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            İzin Takvimi
                        </a>
                        <a href="{{ route('hr.fleet.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.fleet.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('user_management')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ (request()->routeIs('hr.users.*') || request()->routeIs('hr.roles.*') || request()->routeIs('hr.permissions.*')) ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                        @if(request()->routeIs('hr.users.*') || request()->routeIs('hr.roles.*') || request()->routeIs('hr.permissions.*'))
                             <div class="absolute inset-0 rounded-xl bg-neon-active opacity-100 pointer-events-none"></div>
                             <div class="absolute left-0 h-6 w-1 rounded-r-full bg-primary shadow-[0_0_10px_#137fec] pointer-events-none"></div>
                        @endif
                        <div class="flex items-center gap-3">
                    ...
                    <div x-show="isOpen('user_management')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('hr.users.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.users.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('hr.users.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Kullanıcı
                        </a>
                        <a href="{{ route('hr.roles.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.roles.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('hr.roles.*') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Rol
                        </a>
                        <a href="{{ route('hr.permissions.index') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('hr.permissions.*') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <!-- Activities -->
                <a href="{{ route('activities.index') }}" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('activities.index') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                ...
                <div>
                     <button type="button" @click.stop.prevent="toggle('setup')" 
                        class="w-full group relative flex items-center justify-between gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('setup.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <div x-show="isOpen('setup')" x-cloak class="mt-1 space-y-1 pl-4">
                        <a href="{{ route('setup.accounting') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('setup.accounting') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('setup.accounting') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Muhasebe Kurulumu
                        </a>
                        <a href="{{ route('setup.invoice') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('setup.invoice') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('setup.invoice') ? 'bg-primary shadow-[0_0_5px_#137fec]' : 'bg-gray-600' }}"></span>
                            Fatura Kurulumu
                        </a>
                        <a href="{{ route('setup.crm') }}" class="flex items-center gap-3 rounded-lg px-4 py-2 text-sm transition-colors {{ request()->routeIs('setup.crm') ? 'text-white bg-white/10' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                ...
                <div class="pt-4 mt-2 border-t border-white/5">
                    ...
                    <a href="{{ route('superadmin.index') }}" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('superadmin.index') ? 'text-white bg-primary/20' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <a href="{{ route('superadmin.companies.index') }}" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('superadmin.companies.*') ? 'text-white bg-white/5' : 'text-gray-400 hover:text-white' }}">
                    ...
                    <a href="{{ route('superadmin.market.index') }}" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('superadmin.market.index') ? 'text-white bg-white/5' : 'text-gray-400 hover:text-white' }}">
                        <span class="material-symbols-outlined {{ request()->routeIs('superadmin.market.index') ? 'icon-filled text-primary' : 'group-hover:text-primary' }}">storefront</span>
                    ...
                    <a href="#" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 text-gray-400 hover:text-white">
                    ...
                    <a href="{{ route('settings.index') }}" class="group relative flex items-center gap-3 rounded-xl px-4 py-3 transition-all hover:bg-white/5 {{ request()->routeIs('settings.*') ? 'text-white bg-white/5' : 'text-gray-400 hover:text-white' }}">
    ...
    <div class="mt-auto p-4 border-t border-white/10 flex flex-col gap-2 bg-slate-900/50 backdrop-blur-md flex-shrink-0">
            ...
            <!-- User Profile -->
            <a class="flex items-center gap-3 rounded-xl bg-white/5 p-3 hover:bg-white/10 transition-colors border border-white/5" href="{{ route('profile.edit') }}">
                <div class="relative flex-shrink-0">
                    <div class="h-10 w-10 rounded-full bg-gradient-to-tr from-primary to-purple-600 p-[2px]">
                        <div class="w-full h-full rounded-full bg-slate-900 flex items-center justify-center font-bold text-white">
                             {{ substr(Auth::user()->name, 0, 1) }}
                        </div>
                    </div>
                     <div class="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full bg-green-500 ring-2 ring-[#111418]"></div>
                </div>
                <div class="flex flex-col overflow-hidden transition-opacity duration-200 whitespace-nowrap" :class="isCollapsed ? 'opacity-0 w-0 hidden' : 'opacity-100'">
                    <span class="truncate text-sm font-semibold text-white">{{ Auth::user()->name }}</span>
                    <span class="truncate text-xs text-gray-400">Yönetici Hesabı</span>
                </div>
